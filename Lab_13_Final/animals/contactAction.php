...
<button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
 	...
 	<div class="collapse navbar-collapse" id="navbarSupportedContent">
    		<ul class="navbar-nav">
      			...
      			<li class="nav-item active"><a class="nav-link" href="animals_1.html">Home</a></li>
...
<div class="row">
  <div class="col-sm-12">
    <h1>Thank You for contact us, someone will be contacting you within 24 hours.</h1>
    <?php
				...
				echo $success ;
			?>
    <a href="animals_1.html">Return to home page</a><br>
  </div>
</div>
<footer>
